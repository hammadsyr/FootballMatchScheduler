...
import com.example.hammad.fifthkadesubmission.matches.adapter.PreviousAdapter
...
class PrevFragment : Fragment(), AdapterView.OnItemSelectedListener, MatchView {
    ...
    private lateinit var recyclerViewAdapter: PreviousAdapter
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        views = inflater.inflate(R.layout.fragment_prev, container, false)
        spinner = views.prev_spinner
        swipeRefreshLayout = views.prev_swipe_refresh
        recyclerView = views.prev_rv
        ...
        presenter.getPrevMatch(resources.getStringArray(R.array.league_id)[0].toString())
    ...
    override fun onCreateOptionsMenu(menu: Menu?, inflater: MenuInflater?) {
        ...
        searchView.setOnQueryTextListener(object : android.support.v7.widget.SearchView.OnQueryTextListener {
            ...
            override fun onQueryTextSubmit(p0: String): Boolean {
                if (p0 != "") {
                    recyclerViewAdapter = PreviousAdapter(context, recyclerViewAdapter.filter(p0)) {
    ...
    override fun onItemSelected(parent: AdapterView<*>?, view: View?, position: Int, id: Long) {
        presenter.getPrevMatch(resources.getStringArray(R.array.league_id)[position].toString())
    }
    ...
    override fun onListMatch(data: APIResponse.Matches) {
        ...
        recyclerViewAdapter = PreviousAdapter(context, data.events) {
            startActivity<MatchDetail>("id" to it?.idEvent)
        }
        recyclerView.adapter = recyclerViewAdapter
    }
